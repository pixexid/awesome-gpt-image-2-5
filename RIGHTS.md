...
Remote images linked from this repository are not included in or relicensed by the catalogue. Their URLs are provided for reference; image use remains subject to the hosting service’s existing rights and terms. Software under `scripts/` is separately licensed under [MIT](LICENSE-CODE). Alosem names and marks are not licensed for endorsement.
